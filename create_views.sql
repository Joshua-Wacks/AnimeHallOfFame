...
AS
    SELECT c.anime_character_name AS character, ser.anime_series_name AS anime, sea.anime_season_number AS season, dbo.get_hof_rating(b.character_in_season_id) AS rating
